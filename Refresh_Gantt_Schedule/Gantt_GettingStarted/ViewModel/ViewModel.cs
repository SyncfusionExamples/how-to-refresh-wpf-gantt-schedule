...
namespace Gantt_GettingStarted
{
    ...
    class ViewModel
    {
        ...
        public ViewModel()
        {
            ...
            _customScheduleSource = this.GetCustomScheduleSource();
        }
        ...
        private IList<GanttScheduleRowInfo> _customScheduleSource;

        /// <summary>
        /// Gets or sets the custom schedule source.
        /// </summary>
        ...
        public IList<GanttScheduleRowInfo> CustomScheduleSource
        {
            get
            {
                return _customScheduleSource;
            }
            set
            {
                _customScheduleSource = value;
            }
        }
        ...
        public IList<GanttScheduleRowInfo> GetCustomScheduleSource()
        {
            ...
            RowInfo.Add(new GanttScheduleRowInfo() { TimeUnit = TimeUnit.Weeks, CellsPerUnit = 1 });
            RowInfo.Add(new GanttScheduleRowInfo() { TimeUnit = TimeUnit.Days, CellsPerUnit = 1, PixelsPerUnit = 7 });
            return RowInfo;
        }
